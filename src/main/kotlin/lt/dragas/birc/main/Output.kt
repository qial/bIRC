...
import lt.dragas.birc.basic.BasicOutput
import java.io.OutputStream

/**
 * Example implementation of this framework's [BasicOutput] class.
 *
 ...
 */
class Output(outputStream: OutputStream) : BasicOutput(outputStream)
{
}