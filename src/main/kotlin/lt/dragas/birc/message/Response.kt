 ...
 * direct target and message or straight up raw response. By default, BasicOutput calls [toString] to convert this response
 * to string its representation. Does not need to have CLRF terminator appended as BasicOutput already handles that.
 */
